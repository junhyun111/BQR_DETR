...
class MultiScaleRegionSampler(nn.Module):
    ...
    def forward(
        ...
        """Sample `[active_dn, levels, points, hidden]` from encoder memory."""
        samples = []
        for level in range(self.num_levels):
            ...
            # Points are normalized over the unpadded image. Convert them to
            # coordinates in the padded feature-map domain used by grid_sample.
